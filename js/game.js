(function() {
  var WINDOW_HEIGHT, WINDOW_WIDTH, bg, changeRooms, create, door0, door1, game, keys, keysGo, layer1, layer2, layer3, layer4, lighting, onKeyPress, player, preload, rm, update;
  ...
  preload = function() {
    ...
    return game.load.image('light', 'assets/light.png');
  };
  ...
  update = function() {
    ...
    return layer4.x = game.camera.x / -4.5;
  };
